...
# old functions from colab notebook -------------- 
def x_wins(s, Zx, m, d):
    print(s, Zx, m, d)
...
# newer version, better structured but gave unstable results 
def run_cross_inhibition_simulation1(
...
# old version from google colab notebook, which however gave more consistent results 
def run_cross_inhibition_simulation2(
      cycles=100,
      Tmax=50,
      N=100,
      Nhalf=50,
    ...
    # OLD with reactions as global parameters
...
# amended, best of both worlds
def run_cross_inhibition_simulation(
    cycles=100, Tmax=50, N=100, Nhalf=None, m=50, d=10, t=35, h=40,
    Zx=None, Zy=None, qx=None, qy=None, initial_state=None,
    ave_steps=200, plot=False, print_params=True, seed=42):
